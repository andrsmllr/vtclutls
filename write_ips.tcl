...
# Parameters:
#   ips      : list of IP objects (as returned by Vivados get_ips command).
#   ipScript : output file name.
#   safe     : select if ipScript should catch errors. This parameter should
#              be set to True in case ips contains more than one element.
#
# Example:
...
proc write_ips {ips ipScript {safe False}} {
  set ipFH [open $ipScript "w"];
...
"################################################################################";
      ...
      puts $ipFH "} else {";
      puts $ipFH "if \[catch {";
      # PART is a read-only property and will be inherited from the Vivado project.
